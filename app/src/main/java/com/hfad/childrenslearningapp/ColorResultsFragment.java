...
public class ColorResultsFragment extends Fragment {

    public static final String CURRENT_SCORE = "";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String grade = ColorResultsFragmentArgs.fromBundle(requireArguments()).getGradecolor();
        ...
        if (Integer.valueOf(grade) < 3 && currScore == 0)
        {
            ivSkillBar.setImageResource(R.drawable.empty);
        }
        else if (grade == String.valueOf(3))
        {
        ...
        btnHomePage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mpReturnHome.start();
                Navigation.findNavController(view).navigate(R.id.action_colorResultsFragment_to_homeFragment);
            }
        });

        if (savedInstanceState != null)
        {
            currScore = savedInstanceState.getInt(CURRENT_SCORE);
        }
